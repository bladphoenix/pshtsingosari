<div id="app-sidepanel" class="app-sidepanel">
    ...
    <div class="sidepanel-inner d-flex flex-column">
        ...
        <div class="app-branding">
            <a class="app-logo" href="{{ route('admin.dashboard') }}"><img class="logo-icon mr-2"
                    src="{{ config('setting.logo') }}" alt="logo"><span class="logo-text">
                    {{ config('setting.name') }}</span></a>
        </div>
        ...
        <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
            <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                ...
                <li class="nav-item">
                    <a class="nav-link @if(request()->routeIs('admin.rayon.*'))active @endif"
                        ...
                        <span class="nav-link-text">Rayon</span>
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link @if(request()->routeIs('admin.financesocial.*'))active @endif"
                        href="{{ route('admin.financesocial.index') }}">
                        <span class="nav-icon">
                            <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-columns-gap"
                                fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
                ...
                <li class="nav-item has-submenu">
                    ...
                    <div id="submenu-2" class="collapse submenu submenu-2" data-bs-parent="#menu-accordion">
                        <ul class="submenu-list list-unstyled">
                            <li class="submenu-item"><a class="submenu-link" href="javascript:void(0)">Login</a></li>
                        </ul>
                    </div>
                </li>
                @endrole --}}
