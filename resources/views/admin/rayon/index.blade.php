...
<div class="row g-3 mb-4 align-items-center justify-content-between">
    <div class="col-auto">
        <h1 class="app-page-title mb-0">Rayon</h1>
    </div>
    <div class="col-auto">
        <div class="page-utilities">
            <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                <div class="col-auto">
                    <a class="btn app-btn-secondary" href="{{ route('admin.rayon.add') }}">
                ...
                <div class="col-auto">
                    <div class="custom-file">
                        <form action="{{ route('admin.rayon.import') }}" id="import" method="POST"
                    ...
                    <div class="table-responsive">
                        <table class="table app-table-hover mb-0 text-left">
                            <thead>
                                <tr>
                                    <th class="cell">#</th>
                                    <th class="cell">Nama Rayon</th>
                                    <th class="cell">Telepon</th>
                                    <th class="cell">Alamat</th>
                                    <th class="cell">Jumlah Siswa</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="cell">{{ $data->student->count() }} Siswa</td>
                                    <td class="cell"><a class="btn btn-primary text-white btn-sm"
                                            href="{{ route('admin.rayon.detail', $data->id) }}">Detail</a> | <a
                                            class="btn btn-warning text-white btn-sm"
                                            href="{{ route('admin.rayon.edit', $data->id) }}">Edit</a></td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
