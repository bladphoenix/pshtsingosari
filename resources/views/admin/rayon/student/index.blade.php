...
<div class="row g-3 mb-4 align-items-center justify-content-between">
    <div class="col-auto">
        <h1 class="app-page-title mb-0">Siswa Rayon</h1>
    </div>
    <div class="col-auto">
        <div class="page-utilities">
            <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                <div class="col-auto">
                    <a class="btn app-btn-secondary" href="{{ route('admin.rayon.student.add', $data->id) }}">
                ...
                <div class="col-auto">
                    <div class="custom-file">
                        <form action="{{ route('admin.rayon.student.import', $data->id) }}" id="import" method="POST"
                        ...
                        <table class="table app-table-hover mb-0 text-left">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="cell">{{ $student->level->name }}</td>
                                    <td class="cell"><span
                                            class="badge @if($student->status === 'new')btn-primary @elseif($student->status === 'active')btn-info @else btn-danger @endif">{{ $student->status }}</span>
                                    </td>
                                    <form class="settings-form" method="POST"
                                        action="{{ route('admin.rayon.student.suspend', [$data->id, $student->id]) }}">@csrf
                                        <td class="cell"><a class="btn btn-primary text-white btn-sm"
                                                href="{{ route('admin.rayon.student.detail', [$data->id, $student->id]) }}">Detail</a>
                                            | @if($student->status)<button class="btn btn-danger text-white btn-sm"
