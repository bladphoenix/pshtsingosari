@extends('layouts.app')
@push('title')
<title>Tambah Siswa | {{ config('setting.name') }}</title>
@endpush
@push('style')
<link href="{{ asset('assets/plugins/litepicker/litepicker.css') }}" rel="stylesheet">
@endpush
@section('content')
<h1 class="app-page-title">Tambah Siswa</h1>
<hr class="mb-4">
<form class="settings-form" method="POST" action="{{ route('admin.rayon.student.create', $data->id) }}"
    ...
    <div class="tab-content" id="nav-tabContent">
                ...
                <div class="app-card-body p-4">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="address" class="form-control @error('address') is-invalid @enderror"
                            id="address" required style="height: 100px">{{ old('address') }}</textarea>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input name="jobs" type="text" class="form-control @error('jobs') is-invalid @enderror"
                            id="jobs" value="{{ old('jobs') }}" required>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="row align-items-start mb-3">
                        ...
                        <div class="col-6">
                            ...
                            <select class="form-control" name="level" id="level" style="width: 100%">
                                ...
                                <option value="{{ $key }}" {{ old('level')===$level ? "selected" : "" }}>
                                    {{ $level }}</option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="row align-items-start mb-3">
                        <div class="col-6">
                            ...
                            <textarea class="form-control  @error('disease') is-invalid @enderror" style="height: 100px"
                                name="disease">{{ old('disease') }}</textarea>
                        </div>
                        <div class="col-6">
        ...
        <button type="submit" class="btn app-btn-primary w-100">Tambah Siswa</button>
    </div>
</form>
@push('script')
