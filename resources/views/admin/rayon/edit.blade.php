@extends('layouts.app')
@push('title')
<title>Edit Rayon | {{ config('setting.name') }}</title>
@endpush
@section('content')
<h1 class="app-page-title">Edit Rayon</h1>
<hr class="mb-4">
<div class="app-card app-card-settings shadow-sm p-4">
    <div class="app-card-body">
        ...
        @endif
        <form class="settings-form" method="POST" action="{{ route('admin.rayon.update', $data->id) }}"
            ...
            <button type="submit" class="btn app-btn-primary w-100">Ubah Data Rayon</button>
        </form>
    </div>
</div>
@endsection
