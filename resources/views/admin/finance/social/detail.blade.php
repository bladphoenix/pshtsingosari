@extends('layouts.app')
@push('title')
<title>Data Dana Bantuan | {{ config('setting.name') }}</title>
@endpush
@section('content')
<h1 class="app-page-title">Data Dana Bantuan</h1>
<hr class="mb-4">
            ...
            <div class="app-card-body p-4">
                <div class="row align-items-center">
                    <div class="col-12">
                        ...
                        <p><strong>Tipe :</strong> {{ $finance->status === 1 ? 'Tersalurkan' : 'Belum tersalurkan' }}</p>
                ...
                <table class="table app-table-hover mb-0 text-left">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @if($history->old_value === '1' || $history->old_value === '0')
                            <td class="cell">{{ $history->old_value === '1' ? 'Tersalurkan' : 'Belum Tersalurkan' }} ke {{ $history->new_value === '0' ? 'Belum Tersalurkan' : 'Tersalurkan' }}</td>
                            @else
