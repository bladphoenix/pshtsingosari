@php
$in = $data->where('status', 1)->sum('total');
$out = $data->where('status', 0)->sum('total');
$total = $in-$out;
@endphp
@extends('layouts.app')
@push('title')
...
<div class="row g-3 mb-4 align-items-center justify-content-between">
    <div class="col-auto">
        <h1 class="app-page-title mb-0">Dana Bantuan</h1>
    </div>
    <div class="col-auto">
        <div class="page-utilities">
            <div class="row g-2 justify-content-center align-items-center">
                <div class="col-auto">
                    <a class="btn app-btn-secondary" href="{{ route('admin.financesocial.create') }}">
    ...
    <div class="inner">
        <div class="app-card app-card-orders-table shadow-sm mb-5">
            <div class="app-card-body p-4">
                <form action="{{ route('admin.financesocial.index') }}" method="GET" class="row">
                    @csrf
                    ...
                    <div class="mb-3 col-lg-3 col-md-12">
                        <select name="status" class="form-control">
                            <option value="all" {{ \Request::get('status')==='all' ? 'selected' : 'selected' }}>Semua
                            </option>
                            <option value="in" {{ \Request::get('status')==='1' ? 'selected' : '' }}>Tersalurkan</option>
                            <option value="out" {{ \Request::get('status')==='0' ? 'selected' : '' }}>Belum Tersalurkan</option>
                        </select>
                    </div>
                    <div class="mb-3 col-lg-3 col-md-12">
            ...
            <div class="app-card-body p-4">
                <div class="row align-items-center">
                    <div class="col-12">
                        ...
                        <p><strong>Tersalurkan : Rp. {{ number_format($in) }}</strong></p>
                        <p><strong>Belum Tersalurkan : Rp. {{ number_format($out) }}</strong></p>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <table class="table app-table-hover mb-0 text-left">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="cell">{{ $value->status === 1 ? 'Tersalurkan' : 'Belum Tersalurkan' }}</td>
